...
INSERT INTO player (player_id, name, birthday, jersy_number, team_id) VALUES (1, 'Salem Al Dawsari', 1991, 11, 3);
INSERT INTO player (player_id, name, birthday, jersy_number, team_id) VALUES (2, 'Odil Akhmedov', 1987, 7, 2);
INSERT INTO player (player_id, name, birthday, jersy_number, team_id) VALUES (3, 'Andre Carrillo', 1991, 9, 3);
INSERT INTO player (player_id, name, birthday, jersy_number, team_id) VALUES (4, 'Fabio Lima', 1987, 10, 4);
INSERT INTO player (player_id, name, birthday, jersy_number, team_id) VALUES (5, 'Youssef Msakni', 1990, 11, 5);
INSERT INTO player (player_id, name, birthday, jersy_number, team_id) VALUES (6, 'Mohammed Al-Breik', 1993, 13, 3);
INSERT INTO player (player_id, name, birthday, jersy_number, team_id) VALUES (7, 'Abdullah Al-Muwallad', 1994, 15, 7);
INSERT INTO player (player_id, name, birthday, jersy_number, team_id) VALUES (8, 'Vahid Amiri', 1990, 8, 8);
INSERT INTO player (player_id, name, birthday, jersy_number, team_id) VALUES (9, 'Tatsuya Ito', 1996, 22, 9);
...
INSERT INTO match (match_id, season, status, date_time, stadium, match_group, origin_competition_id, origin_competition_name, home_team_id, away_team_id, result_id, stage_id)
VALUES (1, 2024, 'played', '2024-01-03 00:00:00', NULL, NULL, 'afc-champions-league', 'AFC Champions League', 1, 2, 1, 1);

INSERT INTO match (match_id, season, status, date_time, stadium, match_group, origin_competition_id, origin_competition_name, home_team_id, away_team_id, result_id, stage_id)
VALUES (2, 2024, 'scheduled', '2024-01-03 16:00:00', NULL, NULL, 'afc-champions-league', 'AFC Champions League', 3, 4, 2, 2);

INSERT INTO match (match_id, season, status, date_time, stadium, match_group, origin_competition_id, origin_competition_name, home_team_id, away_team_id, result_id, stage_id)
VALUES (3, 2024, 'scheduled', '2024-01-04 15:25:00', NULL, NULL, 'afc-champions-league', 'AFC Champions League', 5, 6, 3, 3);

INSERT INTO match (match_id, season, status, date_time, stadium, match_group, origin_competition_id, origin_competition_name, home_team_id, away_team_id, result_id, stage_id)
VALUES (4, 2024, 'scheduled', '2024-01-04 08:00:00', NULL, NULL, 'afc-champions-league', 'AFC Champions League', 7, 8, 4, 4);

INSERT INTO match (match_id, season, status, date_time, stadium, match_group, origin_competition_id, origin_competition_name, home_team_id, away_team_id, result_id, stage_id)
VALUES (5, 2024, 'scheduled', '2024-01-19 00:00:00', NULL, NULL, 'afc-champions-league', 'AFC Champions League', NULL, 9, NULL, 5);
